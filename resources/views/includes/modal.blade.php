<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered d-flex justify-content-center align-items-center">
        <div class="container modal-content bg-dark d-flex justify-content-center align-items-center">
                <div class="clip_contact w-100 px-4 px-xxl-2 py-2 bg-dark d-flex justify-content-center align-items-center">
                    <div class="">
                        <div class="header_modal_contact d-flex justify-content-between align-items-center mt-xxl-4">
                            <span class="none" ></span>
                            <div class="logo-modal-contact cursor-big">
                        ...
                        <div class="row row-cols-3 row-cols-sm-5 nav_project_type">
                                ...
                                <span class="mb-2 me-u5 cursor-big">Mobile</span>
                        ...
                        <div class="row row-cols-1 px-3 row-cols-lg-2 mt-5 mt-lg-3 form">
                            ...
                            <div class="d-flex flex-column pe-lg-0 ps-lg-5 fr">
                                ...
                                <div class="d-flex justify-content-start justify-content-lg-end align-items-center">
                                    <button id="contact_us" class="cursor-big">
                                        SEND
                                    </button>
                                </div>
                            </div>
